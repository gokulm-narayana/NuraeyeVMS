 ...
 */
app.controller('DashboardController', ['$scope', 'MockBackendService', function ($scope, MockBackendService) {
    ...
    $scope.resolveIssue = function (issue) {
        console.log("Resolve issue action triggered for:", issue);
        // Placeholder for future implementation or modal logic
    };
