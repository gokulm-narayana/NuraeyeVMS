 ...
 */
app.controller('AlertsController', ['$scope', 'MockBackendService', '$interval', function ($scope, MockBackendService, $interval) {
    ...
    $scope.fetchAlerts = function () {
        ...
        MockBackendService.getAlerts(serviceFilters).then(function (alerts) {
            $scope.filteredAlerts = alerts;
